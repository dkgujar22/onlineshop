...
const DashSidebar = () => {
  ...
  return (
    ...
    <ul className="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <NavLink to="/dashboard/showproducts" className={({ isActive }) =>
        isActive ? "nav-link active " : "nav-link text-white"
        }>
    ...
    <div className="dropdown">
      <a href="#" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <strong>mdo</strong> */}
        <p className='email-fontsize'>{user.email}</p>
      </a>
      <ul className="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        {/* <li><a className="dropdown-item" href="#"><button className='bg-transparent border-0 text-white' onClick={Logout}>Logout</button></a></li> */}
        <button className='dropdown-item bg-transparent border-0 text-white' onClick={Logout}>Logout</button>
